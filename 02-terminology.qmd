...
always possible to convert a higher to a lower level. This results in a
certain amount of information loss but sometimes helps to do proper
analysis.

* metric $\righarrow$ ordinal: ranking
* metric or ordinal $\righarrow$ binary: threshold
* nominal $\righarrow$ binary: assign to two groups
