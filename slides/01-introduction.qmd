...
$\Rightarrow$ Practical understanding and "statistical feeling" more important than facts learned by heart.
...
* **Exam:** Written exam at the end of the semester. [Attend the labs!]{.red}
<br>
...
```{r dobson-boxplot, fig.height=3, fig.width=8}
par(mfrow=c(1,2))
