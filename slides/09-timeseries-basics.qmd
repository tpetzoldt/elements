...
Simple linear models require "independent data", or,<br> more precisely: **independence of residuals**.
...
$\rightarrow$ trend removal<br> does not cure non-stationarity
...
* [$\Rightarrow$ test stationarity (or autocorrelation) before or after trend testing !!!]{.red}
...
* Remember: A "TSP" can be made stationary by subtracting a trend.<br>
