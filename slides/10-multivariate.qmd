...
3. The "gauernitz" data set contains simplified teaching versions from research data, published by @Winkelmann
...
* $0 \leq D \leq 1$
* inverse Simpson index: $D' = 1 / D$<br> 
* Simpson-Gini-index: $\tilde{D} = 1 - D$<br>
...
$$
  ...
  * information theory, log often base 2
...
$\rightarrow$ always information loss compared to the original list
