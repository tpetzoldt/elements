...
▶ Starting point: raw data, covariance or correlation matrix
...
▶ similar to two-matrix method, but both steps independent

## Interpretation of CA

* biplot with species and environmental factors, note scaling (α)!
