...
This tutorial is available in [HTML](https://tpetzoldt.github.io/elements/tutorials/s1-introductory-r-session.html) format for screen reading and [PDF](https://tpetzoldt.github.io/elements/tutorials/s1-introductory-r-session.pdf) for printing.
...
The data can be downloaded from [https://github.com/tpetzoldt/datasets/tree/main/data](https://github.com/tpetzoldt/datasets/tree/main/data)
