...
:::{.bigfont}
The examples were tested with R 4.3.1
...
# the $ is used to access a colmn of a data frame
...
## Different plotting packages available with different philosophies
...
* [Functions everywhere](r-functions.html)
