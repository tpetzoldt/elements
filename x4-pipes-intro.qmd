...
::: aside
The `%>%-pipeline was introduced by the user-contributed **magrittr** package [@bache_magrittr_2022] and 
became very popular. It is automatically loaded by the **dplyr** package [@wickham_dplyr_2023].
:::
...
* "R for Data Science" [@wickham_r_2017] 
